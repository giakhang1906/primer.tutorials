...
Write a predicative question which connects the outcome variable `grad_rate` to `tuition`, the covariate of interest. 
...
```{r courage-15}
question_text(NULL,
	message = "When comparing colleges with different tuition rates, we find that, if one college charges $10,000 more in tuition than another, it's graduation rate is also higher by 9%.",
	answer(NULL, correct = TRUE),
	allow_retry = FALSE,
	incorrect = NULL,
	rows = 6)
...
Note that this is not a causal statement. We cannot say that if a college raises its tuition by $10,000, its graduation rate will increase by 9%. 
